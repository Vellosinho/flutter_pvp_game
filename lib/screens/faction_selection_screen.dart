                  ...
                  children: [
                    GameButton(
                      ...
                      onTap: () {
                        context
                            .read<PlayerConsts>()
                            .setFaction(CharacterFaction.Communist);
                      },
                    ),
                    GameButton(
                        enabled: false,
                        ...
                        selectedImage:
                            InterfaceSpriteSheet.ownersBannerSelected,
                        onTap: () {
                          context
                              .read<PlayerConsts>()
                              .setFaction(CharacterFaction.Capitalist);
                        }),
                    GameButton(
                        enabled: true,
                        image: InterfaceSpriteSheet.loyalistsBanner,
                        selectedImage:
                            InterfaceSpriteSheet.loyalistsBannerSelected,
                        onTap: () {
                          context
                              .read<PlayerConsts>()
                              .setFaction(CharacterFaction.Monarchist);
                        }),
                  ],
                ),
                Positioned(
          ...
          onTap: () {
            if (widget.enabled) {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const FactionDetails()));
            } else {}
          },
